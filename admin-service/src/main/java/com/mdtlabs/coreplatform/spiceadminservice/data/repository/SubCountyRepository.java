...
public interface SubCountyRepository extends JpaRepository<Subcounty, Long> {
    ...
    public static final String GET_ALL_SUBCOUNTIES =
            "select subcounty from Subcounty as subcounty where subcounty.countryId=:countryId AND subcounty.countyId=:countyId AND subcounty.isDeleted=false";
