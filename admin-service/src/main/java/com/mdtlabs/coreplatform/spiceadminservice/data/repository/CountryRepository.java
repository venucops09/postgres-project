...
/**
 * This Repository interface maintains connection between Country entity and database
 *
 * @author Karthick M
 */
@Repository
public interface CountryRepository extends JpaRepository<Country, Long> {
    ...
    public static final String GET_ALL_COUNTRIES =
            "select country from Country as country where country.isDeleted=false";
