 ...
 * database. This class used to perform all the PhysicalExamination module action in database.
...
public interface PhysicalExaminationRepository extends JpaRepository<PhysicalExamination, Long> {
	...
	public Set<PhysicalExamination> getPhysicalExaminationByIds(@Param("physicalExaminationIds") Set<Long> physicalExaminationIds);
}
